...
const MySQLPoolConnectionInternal = __importStar(require("./MySQLPoolConnection"));
const PGPoolConnectionInternal = __importStar(require("./PGPoolConnection"));
...
(function (Datasource) {
    ...
    Datasource.PGPoolConnection = PGPoolConnectionInternal.PGPoolConnection;
    Datasource.MySQLPoolConnection = MySQLPoolConnectionInternal.MySQLPoolConnection;
